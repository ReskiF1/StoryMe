...
?>
    ...
    <section class="dashboard">
      <?php if(isset($_SESSION['add-category-success'])) : // ========= add ========= ?>
      ...
      <?php elseif(isset($_SESSION['edit-category-success'])) : // ========= edit ========= ?>
        <div class="alert_message success container">
          <p>
      ...
      <?php elseif(isset($_SESSION['delete-category-success'])) : // ========= delete ========= ?>
        <div class="alert_message success container">
          <p>
